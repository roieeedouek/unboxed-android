...
interface HostRegexDao {
    ...
    @Insert(onConflict = OnConflictStrategy.REPLACE) suspend fun insert(hostRegex: HostRegex)

    @Insert(onConflict = OnConflictStrategy.REPLACE) suspend fun insertAll(list: List<HostRegex>)
